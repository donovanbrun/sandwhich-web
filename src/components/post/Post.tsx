...
export default function Post({ sandwich }: PostProps) {
    ...
    useEffect(() => {
        ...
        // TODO Find something more efficient than this, maybe store the name in the sandwich object
    ...
    return (
        <div className='Post' onClick={handler}>
            <img className="PostImg" src={sandwich.imageUrl} alt={sandwich.name + " image"} /><div className='PostOverlay'>
